...

{
  ...
  vulkan-utility-libraries = pkgs.fetchzip {
    url = "https://github.com/KhronosGroup/Vulkan-Utility-Libraries/archive/refs/tags/v1.4.345.tar.gz";
  ...
  nx-tzdb = pkgs.fetchurl {
    url = "https://git.eden-emu.dev/eden-emu/tzdb_to_nx/releases/download/230326/230326.tar.gz";
    hash = "sha256-5duQ3Wgbbmu0qhOtRGsTjUJHYumWpYMLpdvNiLOpA4s=";
  };
